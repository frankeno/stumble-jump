...
namespace CompleteProject {
    ...
    public class Purchaser : MonoBehaviour, IStoreListener {
        ...
        //// CHANGE THIS IDENTIFIER WITH THE ONE YOU CREATE IN APP STORE CONNECT AND PLAY CONSOLE /////
        ...
        void Update() {
            ...
            // Rotate Loading icon
            loadingIcon.transform.Rotate(0, 0, Time.deltaTime * 90);
        }
